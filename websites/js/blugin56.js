$(document).ready(function(){
      ...
      $(".pay").on({
          click:function(){
              $(this).addClass("active").parent().parent().siblings().find(".pay").removeClass("active")
    ...
    $(".laws .taps  ul li").on({
        click: function() {
            $($(this).data("tap")).addClass("active").siblings().removeClass("active"),
                $(this).addClass("active").siblings().removeClass("active")
        }
    });
    $(" .laws .next").on({
    ...
    $(".first-color , .second-color , .btn-color").on({
        change:function(){
            ...
            $btn = $(".btn-color").val();
            $(".dash .header , .dash .shape-up-curve .block , .dash .shape-up-line .background").css("background-image","linear-gradient(to top, " + $first + "  20%, " +  $second + " 80%)")
            $(".in").css("background-image","linear-gradient(to top, " + $first + "  20%, " +  $second + " 80%)")
            $(".curvee").css("background-image","linear-gradient(to top, " + $first + "  20%, " +  $second + " 80%)")
            $(".linee").css("background-image","linear-gradient(to top, " + $first + "  20%, " +  $second + " 80%)")
			$(".navbar ").css("background-image","linear-gradient(to top, " + $second + " 100%, " + $second + " 100%)");
